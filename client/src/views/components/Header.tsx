    ...
    <div className="z-10 fixed w-full h-14 flex items-center justify-between px-4 bg-[#0F0F0F]">
        ...
        <button>
          <Link to="/">
            <svg
              ...
              focusable="false"
              className="pointer-events-none block w-24"
            >
      ...
      <div className="flex space-x-4 items-center">
        ...
        <Link to="/user/profile">
          <div className="rounded-full bg-slate-400 w-7 h-7" />
        </Link>
        <div className="rounded-3xl border border-gray-700 flex space-x-2 py-1.5 px-3">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
